...
class Gen3RemoteDriver extends Homey.Driver {
    async onInit() {
        ...
        this.homey.flow.getActionCard('set_heater_enabled_gen3').registerRunListener((args, _state) => args.device.setHeaterEnabled(args.state === '1' ? true : false));
        ...
        this.homey.flow.getConditionCard('is_heater_enabled_gen3').registerRunListener((args, _state) => args.device.getCapabilityValue('heater_enabled_gen3'));
        this.homey.flow
